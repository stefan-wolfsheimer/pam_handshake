...
#define PyString_Check(obj) PyObject_IsInstance(obj, (PyObject *)&PyBytes_Type)
#define PyString_AsString(OBJ) PyBytes_AsString(OBJ)
#define PyString_AS_STRING(OBJ) PyBytes_AsString(OBJ)
#define PyString_Type PyBytes_Type
#define PyString_FromString(OBJ) PyBytes_FromString(OBJ)
#define PyString_FromStringAndSize(OBJ, S) PyBytes_FromStringAndSize(OBJ, S)
#define PyString_Size(OBJ) PyBytes_Size(OBJ)
#define PyString_GET_SIZE(OBJ) PyBytes_Size(OBJ)
#define PyExc_StandardError PyExc_RuntimeError
  ...
  PamHandleObject** result, pam_handle_t* pamh, const char** argv)
{
  ...
  pamHandle->exception = PyErr_NewException(PAMHANDLE_NAME "." PAMHANDLEEXCEPTION_NAME,
